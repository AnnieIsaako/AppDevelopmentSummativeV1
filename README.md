...
This repository is the back end version of our project. If cloning this reposity, you will have to also have a server running and have it connected to mongodb. The repo for our front end is located [here](https://github.com/AnnieIsaako/frontEndDigimartSummative). This is forked from [Larissa Casey's Repo](https://github.com/risscasey/AppDevelopmentSummative-FE).
